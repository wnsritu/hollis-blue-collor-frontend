export const providers = [
  {
    id: "1",
    name: "Maria's Home & Cleaning Care",
    ...
    description: "With over 10 years of experience in professional home services, Maria's Care provides top-quality house cleaning and home management.",
  ...
  },
  {
    ...
    distance: "4.1 miles",
    startingPrice: 4.49,
    services: ["Car Wash", "Detailing", "Waxing"],
    languages: ["English", "French"],
    location: "Midtown, Miami",
    description: "Fresh & Clean Co. specializes in premium detailing and home care services with same-day turnaround.",
  ...
  },
  {
    ...
    distance: "1.8 miles",
    startingPrice: 5.99,
    services: ["Plumbing", "Pipe Inspection", "Fixture Install"],
    languages: ["English", "Portuguese"],
    location: "Brickell, Miami",
    description: "Sparkle Hub brings premium care to your everyday plumbing and maintenance needs.",
    availability: ["Afternoon", "Evening"],
  },
  {
    id: "4",
    name: "Pro Electrical & Handyman",
    ...
    description: "Pro Electrical offers affordable, reliable electrical and handyman services with fast turnaround times.",
