        ...
        <div className="border-r border-border p-4">
          ...
          {loadingThreads ? (
            ...
            <div className="space-y-1 overflow-y-auto max-h-[520px]">
              {threads.map((t) => {
                const threadId = (t.id || t.chat_id || "") as string | number;
                const isActive = String(threadId) === String(activeThreadId);
                const title = (t.project as any)?.title || (t.other_user as any)?.full_name || `Chat #${threadId}`;
                ...
                return (
                  ...
                  >
                    ...
                    <p className="line-clamp-1 text-xs text-muted-foreground">
                      {String(t.last_message || "Start messaging...")}
                    </p>
                  </button>
                );
              })}
              ...
              <div className="flex items-center justify-between border-b border-border p-4 bg-muted/20">
                <div>
                  <h3 className="font-display font-bold text-base">
                    {(activeThread.project as any)?.title || (activeThread.other_user as any)?.full_name || "Project Chat"}
                  </h3>
