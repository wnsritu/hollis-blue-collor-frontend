...
export const queryKeys = {
  ...
  catalog: {
    ...
    serviceTypes: (categoryId?: number | string) =>
      ["catalog", "serviceTypes", categoryId ?? "all"] as const,
  },
  providers: {
    all: ["providers"] as const,
    search: (params?: unknown) => ["providers", "search", params ?? {}] as const,
    ...
    leads: ["providers", "leads"] as const,
  },
  projects: {
    ...
    matches: (id: number | string) => ["projects", "matches", id] as const,
  },
  proposals: {
